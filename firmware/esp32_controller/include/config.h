...
const servoStruct s_torso = {400, 1500, 2500};   // TORSO
...
const servoStruct s_rl2 =   {500, 1480, 2440};    // RIGHT LEG FEMUR
const servoStruct s_rl3 =   {500, 1520, 2500};    // RIGHT LEG TIBIA
const servoStruct s_rl4 =   {500, 1500, 2500};    // RIGHT LEG ANKLE

const servoStruct s_ll1 =   {500, 1500, 2500};    // LEFT LEG THIGH
const servoStruct s_ll2 =   {500, 1540, 2500};    // LEFT LEG FEMUR
const servoStruct s_ll3 =   {500, 1480, 2500};    // LEFT LEG TIBIA
